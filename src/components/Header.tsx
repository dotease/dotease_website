        ...
        if (!data) {
            return (
                <div className="flex justify-center gap-20 sm:gap-3">
                    <LinkButton name={"Login"} link={"/auth/register"} text_color={"text-white"} bg_color={"bg-teal-600"}/>
                    <LinkButton name={"Register"} link={"/auth/register"} text_color={"text-teal-600"} bg_color={"bg-gray-100"}/>
                </div>
            )
        }
        else {
                ...
                <div className="flex flex-row-reverse h-screen justify-between content-end">
                    <div className="w-4/5 bg-white px-4 border-s border-t">
                        <nav aria-label="Main Nav" className="mt-6 flex flex-col space-y-1">
                            ...
                            <details hidden={!data} className="group [&_summary::-webkit-details-marker]:hidden">
                                <summary
